...
public class AuthService {
    ...
    public AuthResponse register(AuthRequest authRequest) {
        if (userRepository.findByUsername(authRequest.username()).isPresent()) {
            ...
            Users user = Users.builder().username(authRequest.username()).hashPassword(authRequest.password()).build();
    ...
    public AuthResponse login(AuthRequest authRequest) {
        Users user = userRepository.findByUsername(authRequest.username()).orElse(null);
        if (user == null) {
